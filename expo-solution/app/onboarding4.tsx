        ...
        <View style={Onboarding1Styles.contentContainer}>
          ...
          <View style={Onboarding1Styles.buttonContainer}>
            <View style={Onboarding1Styles.titleContainer}>
              <Text style={[Onboarding1Styles.title, { color: colors.text }]}>Discover new games</Text>
              <Text style={[Onboarding1Styles.subTitle, { color: dark? COLORS.white : COLORS.primary }]}>Find the best games to play online</Text>
            </View>
